...
class AlienInvasion:
    ...
    def _create_alien(self, alien_number, row_number):                          # we set up a loop to count aliens we need to make
        ...
        alien_width, alien_height = alien.rect.size                             #muliply aline width by 2 for space between, multiply by position
